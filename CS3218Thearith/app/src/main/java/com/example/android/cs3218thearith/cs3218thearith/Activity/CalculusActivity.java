...
import com.example.android.cs3218thearith.cs3218thearith.SurfaceView.CSurfaceViewCalculus;
...
public class CalculusActivity extends Activity implements SeekBar.OnSeekBarChangeListener {
    ...
    private double integrateByTrapezium()
    {
        ...
        for(int i=0; i<bufferSize-1; i++) {
            integral += ((productSig_double[i] + 
                productSig_double[i+1]) * deltaTime) / 2.0;
        }
