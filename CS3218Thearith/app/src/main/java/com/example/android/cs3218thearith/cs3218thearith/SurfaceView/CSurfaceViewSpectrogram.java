...
public class CSurfaceViewSpectrogram extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public class DrawThread extends Thread
    {
        ...
        public DrawThread(SurfaceHolder drawSurfaceHolder, Context drawContext, Handler handler) {
            soundSurfaceHolder = drawSurfaceHolder;
        ...
        public void doDraw(Canvas canvas) {
            ...
            canvas.drawText("'Capture Sound' to see Live Spectrogram", 55, 30, paint);
        ...
        public void run()
        {
            while (drawFlag)
            {
                ...
                try
                {
                    //Log.d("CSurfaceViewSpectrogram", "Height: " + soundCanvasHeight);
