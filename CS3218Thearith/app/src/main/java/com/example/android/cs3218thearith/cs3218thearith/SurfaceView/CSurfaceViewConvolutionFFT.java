 ...
 */
public class CSurfaceViewConvolutionFFT extends SurfaceView implements SurfaceHolder.Callback{
    ...
    public CSurfaceViewConvolutionFFT(Context ctx, AttributeSet attributeSet)
    {
