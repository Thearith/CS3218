 ...
 */
public class CSurfaceViewCorrelation extends SurfaceView implements SurfaceHolder.Callback{
    ...
    public CSurfaceViewCorrelation(Context ctx, AttributeSet attributeSet)
    {
    ...
    public class DrawThread extends Thread
    {
        ...
        public DrawThread(SurfaceHolder paramContext, Context paramHandler, Handler arg4)
        {
            ...
            convol = new double[600];

            double[] xr = new double[400];
            double[] xs = new double[600];
